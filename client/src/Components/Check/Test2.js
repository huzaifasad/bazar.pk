        ...
        <>
            ...
            <div className='flex'>
                ...
                <div className={`bg-navy-blue text-white h-screen p-6 pt-9 ${open ? 'w-80' : 'w-20'}  transition-all duration-500 relative `}>
                    ...
                    < HiMenuAlt1 className={`bg-white text-5xl shadow-md ring-blue-500 cursor-pointer rounded text-black absolute right-[-3rem] top-0 p-2 ${!open && 'rotate-180 transition-all duration-500'}`} onClick={() => setOpen(!open)} />
                  <Link to={`additem`}>
                    <div className='inline-flex'>
                        ...
                        <h1 className={`origin-left text-2xl ml-2 ${!open && 'scale-0'}`}>Dashboard</h1>
                    </div>
                    </Link>
                    <Link to={`removeitem`}>
                    <div className='inline-flex'>
                        ...
                        <h1 className={`origin-left text-2xl ml-2 ${!open && 'scale-0'}`}>Remove</h1>
                    </div>
                    </Link>
